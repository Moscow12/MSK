...
?>     
        <body class="container" id="tableh">
                            ...
                            <table class="table" id="tabled">
                                <tbody>
                                    <tr>
                                        ...
                                        <td><input type="text"class="form-control"  name="diabetic_clinic_no" style="align: center;"> </td>
                                    </tr>
                                    <tr>
                                        <th>sirname</th>
                                    ...
                                    <table class="table" >
                                        ...
                                        <tbody id="addform">
                                            <tr >
                                                ...
                                                <td ><a class="btn btn-warning"  onclick="addForm()">+</a></td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>
